...
/** 实时翻译 */
export const translateRoutes: RouteRecordRaw[] = [
  {
    path: "/rtasr",
    component: () => import("@/pages/translate/rtasr.vue"),
    name: 'RtAsr',
    meta: {
      title: "语音识别（实时）",
    }
...
export const router = createRouter({
  ...
  routes: [...systemRoutes, ...routes, ...demoRoutes, ...emptyDemoRoutes, ...translateRoutes]
})
